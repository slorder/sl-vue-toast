<template>
  <!--忘记密码-->
  <div id="forgetPwd" class="left">
    <home-header :title="'忘记密码'" :back="true"></home-header>
    <main class="login-main">
      ...
      <submit-btn :min="true" @click.native="forgetPwd()" :title="'确定'"></submit-btn>
    </main>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      forgetPwd() {
        let that = this;
        if (!that.passCheck && that.password) {
          that.ajax({
